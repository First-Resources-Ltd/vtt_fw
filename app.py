...
def process_transcribe(tempFile: str):
    # 01 Set up a process manager
    process_manager = Manager()
    shared_data = process_manager.dict()
    
    # 02 Create child process for whisper execution
    ...
    # 03 Get transcription from shared data and delete
